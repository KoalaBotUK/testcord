.. testcord documentation master file, created by
   sphinx-quickstart on Thu Apr  9 15:30:30 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to the testcord documentation!
======================================

The ``testcord`` library is designed to make testing of discord bots easy and painless.
